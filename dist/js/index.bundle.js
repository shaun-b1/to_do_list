...
*/
  ...
  \**************************/
      /***/ (
        ...
        /* harmony import */ var _project_manager__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./project_manager */ "./js/project_manager.js"
          );
        ...
        function submitNewTodo(e, modal) {
          ...
          console.log(
            _project_manager__WEBPACK_IMPORTED_MODULE_2__.projectManager.getCurrentProject()
              .todos
          );
          modal.remove();
        }
